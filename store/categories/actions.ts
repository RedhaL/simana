...
const addTask = (state: CategoryState, action: IAction, dispatch: (action: IAction) => void) => {
    const id = uuidv4();
...
export default function categoryMiddleware(state: CategoryState, action: IAction, dispatch: Dispatch): void {
